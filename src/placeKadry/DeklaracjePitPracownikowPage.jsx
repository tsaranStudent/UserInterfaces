...
export const DeklaracjePitPracownikow = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Deklaracje PIT dla Pracowników</h2>
                <p className="text-muted">Zarządzaj rocznymi deklaracjami PIT-11 dla pracowników w 2025 roku.</p>
            </div>

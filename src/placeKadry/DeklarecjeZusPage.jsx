...
export const DeklarecjeZus = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Deklaracje ZUS</h2>
                <p className="text-muted">Zarządzaj deklaracjami ZUS dla pracowników w 2025 roku.</p>
            </div>
                        ...
                        <Row className="mb-3">
                            <Col md={6}>
                                <Form.Group>
                                    ...
                                    <Form.Control type="month" defaultValue="2025-06" />
                                </Form.Group>
                            </Col>
                            <Col md={6}>
                                <Form.Group>

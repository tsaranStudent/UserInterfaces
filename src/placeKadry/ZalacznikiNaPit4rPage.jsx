...
export const ZalacznikiNaPit4r = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Załączniki na PIT-4R</h2>
                <p className="text-muted">Zarządzaj załącznikami na PIT-4R dla pracowników w 2025 roku.</p>
            </div>

    ...
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Listy Płac</h2>
                <p className="text-muted">Przegląd listy płac i weryfikacja wynagrodzeń pracowników za 2025 rok.</p>
            </div>
                    ...
                    <Form>
                        ...
                        <Row className="mb-3">
                            ...
                            <Col md={6} className="d-flex align-items-center justify-content-end">
                                <Button variant="primary" size="lg">Generuj listę płac</Button>
                            </Col>
                        </Row>
                    </Form>
                </Card.Body>

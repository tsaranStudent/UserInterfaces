...
export const PodatekNaPit8ar = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Podatek na PIT-8AR</h2>
                <p className="text-muted">Zarządzaj podatkami na PIT-8AR dla pracowników w 2025 roku.</p>
            </div>

...
export const DeklaracjeRoczneZswa = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Deklaracje Roczne ZSWA</h2>
                <p className="text-muted">Zarządzaj rocznymi deklaracjami ZSWA dla pracowników w 2025 roku.</p>
            </div>

...
export const DeklarazjeRoczneIwa = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Deklaracje Roczne IWA</h2>
                <p className="text-muted">Zarządzaj rocznymi deklaracjami IWA dla pracowników w 2025 roku.</p>
            </div>

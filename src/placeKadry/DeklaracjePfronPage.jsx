...
export const DeklaracjePfron = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Deklaracje PFRON</h2>
                <p className="text-muted">Zarządzaj deklaracjami PFRON dla pracowników w 2025 roku.</p>
            </div>

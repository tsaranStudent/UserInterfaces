...
export const InformacjeJpk = () => {
    return (
        <Container className="main-content">
            <div className="form-section">
                <h2 className="page-title">Informacje JPK</h2>
                <p className="text-muted">Przegląd danych z JPK (2025)</p>
            </div>

            <Tabs defaultActiveKey="informacje" className="mb-4">
                <Tab eventKey="informacje" title="Informacje JPK">
                    <div className="actions-bar mb-3">
                        <div className="actions-bar-start">
                            <Button variant="primary">Generuj raport JPK</Button>
                            <Button variant="outline-secondary">Eksportuj do PDF</Button>
                        </div>
                        <div className="actions-bar-end">
                            <Form.Select className="me-2" style={{ width: '150px' }}>
                                <option>Wszystkie</option>
                                <option>Faktury sprzedaży</option>
                ...
                <Tab eventKey="rozliczenie" title="Rozliczenie JPK">
